...
<Card>
  Ensure consistent salsa quality with AI-powered prediction and automated IoT
  testing.
</Card>
## Overview
...
<CardGroup cols={2}>
  <Card title="Predictive Quality Scoring" icon="chart-line">
  ...
  <Card title="Anomaly Detection" icon="sensor-triangle-exclamation">
...
<CardGroup cols={2}>
  <Card title="Connected Testing Equipment" icon="rectangle-beta">
  ...
  <Card title="Computer Vision Inspection" icon="camera">
...
<Note>
  **New in v2.0:** Computer vision systems can inspect 100% of production,
  compared to manual sampling in v1.0.
</Note>
...
<CardGroup cols={2}>
  <Card title="Smart Standards" icon="shield-check">
  ...
  <Card title="Real-Time Compliance" icon="file-check">
...
<CardGroup cols={2}>
  <Card title="AI-Powered Analytics" icon="chart-mixed">
  ...
  <Card title="Continuous Improvement" icon="sparkles">
