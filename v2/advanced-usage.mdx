...
<Card>
  Unlock the full potential of Salsa as a Service v2.0 with AI-powered features,
  IoT integration, advanced automation, and enterprise-grade capabilities.
</Card>
...
<Steps>
  ...
  <Step title="">
    **Configure Data Sources** Connect additional data sources to improve accuracy:
...
<Step title="">
  **Set Alert Thresholds** Configure alerts for significant forecast changes or
  anomalies.
</Step>

  <Step title="">
    **Enable Auto-Actions** Let AI automatically adjust production schedules based on forecasts.
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Accuracy Metrics" icon="gauge-high">
    Monitor and improve your forecast accuracy over time:
...
<Accordion title="Model Performance" icon="chart-mixed">
...
<Accordion title="Order Logic" icon="brain">
...
<Accordion title="Order Monitoring" icon="eye">
...
<Accordion title="Smart Production Scheduling" icon="clock">
AI optimizes production schedules for maximum efficiency:

</Accordion>

<Accordion title="Workflow Automation" icon="cogs">
Create custom automation workflows with our visual workflow builder:

<Steps>
  <Step title="">
    **Choose Trigger** Select what initiates the workflow:
      - Time-based (schedule)
...
**Define Conditions** Set conditions that must be met:
...
**Configure Actions** Choose automated actions:
  ...
  <Step title="">
    **Set Approvals** Optional: require human approval before executing certain actions.
  </Step>
</Steps>
...
<AccordionGroup>
  <Accordion title="Centralized Dashboard" icon="chart-tree-map">
...
<Accordion title="Location Groups" icon="layer-group">
...
<Accordion title="Recipe Distribution" icon="utensils">
...
- Maintain recipe consistency across locations
  ...
  <Accordion title="Inventory Transfers" icon="truck-arrow-right">
...
<CardGroup cols={2}>
  ...
  <Card title="API Response Caching" icon="server">
    Frequently accessed data cached with configurable TTL
  </Card>
  <Card title="Client-Side Caching" icon="mobile">
...
<CardGroup cols={2}>
  ...
  <Card title="Developer Community" icon="users">
    Join our Discord for peer support and best practices
  </Card>
</CardGroup>
