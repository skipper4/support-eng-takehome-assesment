...
<Tab title="Python">Python SDK for data analysis and automation.</Tab>
...
<Warning>
  The sandbox environment uses test data and doesn't affect your production
  account.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Documentation" icon="book">
    Browse our comprehensive API guides
  </Card>
